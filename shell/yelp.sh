...
python3 step1_preprocessing.py from_file=YES file_name=yelp_distribution > ../logs/step1_yelp_distribution.log &&

python3 step2_searches.py from_file=YES file_name=yelp > ../logs/step2_yelp.log &&
